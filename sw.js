const CACHE='jogos-v31';
const ARQS=['./','./index.html','./matematica.html','./portugues.html','./ciencias.html','./geografia.html','./historia.html','./manifest.json','./icon-192.png','./icon-512.png','./apple-touch-icon.png'];
